        ...
        <Stagger className="text-center max-w-4xl">
          ...
          <StaggerItem>
            <div className="flex flex-col gap-4 items-center">
              <a
                href="#products-india"
                className="rubik-regular w-44 px-6 py-2.5 border-2 border-[#FFDCDC] text-[#FFDCDC] bg-transparent uppercase text-base hover:bg-[#FFDCDC] hover:text-[#C4735A] transition-all inline-block text-center rounded-lg"
              >
                Order Now
              </a>
              <a
          ...
          <Stagger className="max-w-2xl">
            ...
            <StaggerItem>
              <div className="flex gap-4 md:gap-6 justify-center lg:justify-start">
                <a
                  href="#products-india"
                  className="rubik-regular w-44 md:w-52 px-6 md:px-8 py-2.5 md:py-3 border-2 border-[#FFDCDC] text-[#FFDCDC] bg-transparent uppercase text-base md:text-lg hover:bg-[#FFDCDC] hover:text-[#C4735A] transition-all inline-block text-center rounded-lg"
                >
                  Order Now
                </a>
                <a
